...
contract Presale is Ownable {
    ...
    uint256 public MAX_BUY_LIMIT = 5000000000000000000;
    uint256 public majorOwnerShares = 100;
    uint public    referralReward = 10;
    uint256 public rate = 5000;
    uint256 public airdropTokens = 5000000000000000000;
    ...
    XMAGNET public token;
    
    
    constructor(address payable _walletMajorOwner) 
    {
        token = XMAGNET(0xA9686056Aa043E49D560FC4B0fD163CEef17D0C9); 
